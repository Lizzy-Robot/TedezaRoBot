...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        kb.append([InlineKeyboardButton(text='Support', url='https://t.me/cuddles_of_pandas'),
        InlineKeyboardButton(text='Anisha', callback_data='start_back'), InlineKeyboardButton(text="Try inline", switch_inline_query_current_chat="")])
                    ...
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                ...
                                url="https://t.me/cuddles_of_pandas",
                            ),
                            InlineKeyboardButton(
